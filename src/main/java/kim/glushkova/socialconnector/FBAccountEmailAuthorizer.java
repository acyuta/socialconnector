...
class FBAccountEmailAuthorizer implements Authorizer, AuthorizedInit {
    FBAccountEmailAuthorizer() {
    }
    ...
    @Override
    public FBAccountEmailAuthorizer initForActivity(Activity activity, AuthenticationCallback callback) {
    ...
    @Override
    public FBAccountEmailAuthorizer initForFragment(Fragment fragment, AuthenticationCallback callback) {
        this.callback = callback;
    ...
    @Override
    public FBAccountEmailAuthorizer intForFragment(android.support.v4.app.Fragment fragment, AuthenticationCallback callback) {
        this.callback = callback;
